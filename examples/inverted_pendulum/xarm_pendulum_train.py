...
def get_task_cfgs():
    env_cfg = {
        ...
        "action_joint_names": ["joint2"],
        "dependent_joints": [
            {"target": "joint1", "source": "joint2", "scale": 0.0, "offset": 0.0},
            {"target": "joint3", "source": "joint2", "scale": -2.0},
            {"target": "joint4", "source": "joint1", "scale": 1.0, "offset": math.pi / 2},
            {"target": "joint5", "source": "joint1", "scale": 0.0, "offset": -math.pi / 2},
            {"target": "joint6", "source": "joint2", "scale": -1.0},
        ],
        "joint_limit_overrides": {
            "joint2": [0, math.pi / 2],
        },
        "action_center_ranges": {
            "joint2": [0.04, 1.3],
        },
        "action_center_penalty": 2.0,
        "action_center_sigma": 0.05,
        "pendulum_joint_name": "pendulum_hinge",
        "pendulum_link_name": "pendulum",
        "default_joint_pos": [0.0, 0.4, -0.4, 0.0, -1.57, 0.0],
        ...
        "kp": 600.0,
        "kd": 30.0,
        "init_joint_noise": 0.01,
        "init_pendulum_noise": 0.05,
        "termination_cos_threshold": math.cos(math.radians(10.0)),
